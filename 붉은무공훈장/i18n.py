...
UI = {
    ...
    "q1v3_t": {"KR": "편의점에서 아르바이트를 하고 있습니다. 평소 폐점을 도와주던 단골이 거스름돈 천 원이 부족합니다. 계산대 규정은 정확히 받아야 합니다. 당신의 선택은?",
               ...
               "JP": "コンビニでアルバイトをしています。いつも閉店を手伝ってくれる常連が千円足りません。規定では正確に受け取るべきです。あなたの選択は？"},
    ...
    "q1v5_t": {"KR": "기숙사 소등·정숙 시간입니다. 오늘 하루가 힘들었던 같은 방 친구가 음악을 틀고 있습니다. 기숙사 사감으로서 경고를 해야 합니다. 당신의 선택은?",
               "EN": "It's dorm quiet hours. Your roommate, after a brutal day, is playing music. As the dorm supervisor you should warn them. Your choice?",
               "CH": "宿舍已到熄灯与安静时间。经历艰难一天的室友在放音乐。作为宿舍管理员，你应警告。你的选择是？",
               "JP": "寮の消灯・静粛時間です。つらい一日を過ごしたルームメイトが音楽をかけています。寮の指導員として注意すべきです。あなたの選択は？"},
    ...
    "q2v2_t": {"KR": "실험 보고서에서 당신이 시약을 잘못 섞었고, 그 결과로 좋은 성적을 받았습니다. 당신만 알고 있습니다. 당신의 선택은?",
               "EN": "In a lab report you mixed the wrong reagent and still got a high mark. Only you know. Your choice?",
               "CH": "实验报告里你混错了试剂，却因此拿了高分。只有你知道。你的选择是？",
               "JP": "実験レポートで試薬を混ぜ間違え、その結果良い成績を取りました。知っているのはあなただけです。あなたの選択は？"},
    ...
    "q2v3_a": {"KR": "스스로 손을 들고 반칙을 인정한다.", "EN": "Raise your hand and admit the foul.", "CH": "主动举手承认犯规。", "JP": "自ら手を挙げて反則を認める。"},
    ...
    "q2v5_t": {"KR": "코딩 대회에서 금지된 인공지능을 몰래 썼고, 당신만 압니다. 순위를 지킬 수 있습니다. 당신의 선택은?",
               "EN": "In a coding contest you secretly used banned AI help; only you know. You can keep your rank. Your choice?",
               "CH": "编程比赛中你偷偷用了禁用的人工智能，只有你知道。可以保住名次。你的选择是？",
               "JP": "プログラミング大会で禁止されている人工知能をこっそり使い、知っているのは自分だけ。順位を守れます。あなたの選択は？"},
    ...
    "q3v2_t": {"KR": "인턴 추천 자리가 하나뿐입니다. 지도교수는 당신과, 형편이 더 절실한 친구 중 하나만 추천할 수 있습니다. 당신의 선택은?",
    ...
    "q3v3_t": {"KR": "내일 중요한 면접이 있어 쉬려던 밤, 응급실 자원봉사 마지막 자리가 비었습니다. 지금 가면 잠을 못 잡니다. 당신의 선택은?",
               "EN": "The night before a big interview you planned to rest, but the last emergency-room volunteer slot opens. Going means no sleep. Your choice?",
    ...
    "q3v4_t": {"KR": "중간고사 직전, 열람실 컴퓨터가 두 시간만 남았습니다. 당신은 복습이 필요하고, 친구는 내일까지 논문이 급합니다. 당신의 선택은?",
               "EN": "Right before midterms, only two hours remain on the library computer. You need to review; a friend has a thesis due tomorrow. Your choice?",
               "CH": "期中考前，阅览室电脑只剩两小时。你要复习，朋友明天要交论文。你的选择是？",
               "JP": "中間試験直前、閲覧室のパソコンはあと2時間。あなたは復習が必要で、友人は明日締切の論文が急です。あなたの選択は？"},
    "q3v4_a": {"KR": "내 시험을 위해 컴퓨터를 쓴다.", "EN": "Use the computer for my own exam prep.", "CH": "为了我的考试使用电脑。", "JP": "自分の試験のためにパソコンを使う。"},
    ...
    "an_sum_consistent": {"KR": "당신은 사전 성향과 게임 속 선택이 대체로 '일관'되었습니다.\n신념이 위기 상황에서도 흔들리지 않는 유형입니다.",
                          "EN": "Your pre-survey tendencies and in-game choices were largely 'consistent'.\nYour convictions held steady even under pressure.",
                          "CH": "你的事前倾向与游戏中的选择大体'一致'。\n属于在危机中信念也不动摇的类型。",
                          "JP": "あなたの事前傾向とゲーム内の選択はおおむね「一貫」していました。\n危機でも信念が揺らがないタイプです。"},
    "an_sum_mixed":      {"KR": "당신은 사전 성향과 게임 속 선택 사이에 '반전'이 있었습니다.\n극한 상황이 평소의 신념과 다른 선택을 이끌어냈습니다.",
                          "EN": "There were 'reversals' between your survey tendencies and in-game choices.\nExtreme situations drew out choices different from your usual beliefs.",
                          "CH": "你的事前倾向与游戏选择之间出现了'反转'。\n极端处境引出了与平日信念不同的选择。",
                          "JP": "事前傾向とゲーム内の選択に「反転」がありました。\n極限状況が普段の信念と異なる選択を引き出したのです。"},
    "rotate_hint": {"KR": "화면을 가로로 돌려 주세요", "EN": "Please rotate to landscape", "CH": "请横屏使用", "JP": "横向きにしてください"},
