...
UI = {
    ...
    "q1v5_t": {"KR": "기숙사 소등·정숙 시간입니다. 오늘 하루가 힘들었던 학생이 음악을 틀고 있습니다. 기숙사 사감으로서 경고를 해야 합니다. 당신의 선택은?",
               "EN": "It's dorm quiet hours. A student who had a hard day is playing music. As the dorm supervisor you should warn them. Your choice?",
               "CH": "宿舍已到熄灯与安静时间。经历艰难一天的学生在放音乐。作为宿舍管理员，你应警告。你的选择是？",
               "JP": "寮の消灯・静粛時間です。つらい一日を過ごした生徒が音楽をかけています。寮監として注意すべきです。あなたの選択は？"},
